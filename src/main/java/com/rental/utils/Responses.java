...
public interface Responses {
	...
	String USER_NOT_FOUND_CODE = "EX1007";
	...
	String INSUFFICIENT_BALANCE_TO_ORDER_MESSAGE = "you don't have enough balance to order the stocks";
	String INSUFFICIENT_PAGE_VALUE_MESSAGE = "Please provide valid page details";
	String INSUFFICIENT_PAGE_VALUE_CODE = "EX1006";
	String VALIDATION_ERROR_CODE = "EX1007";
